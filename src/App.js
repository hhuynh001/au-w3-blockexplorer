    ...
    return (
      <>
        <div>
            ...
            <div>
                <button style={{marginRight: 24}} onClick={() => previousBlock()}>Previous Block</button> <b style={{marginRight: 2}}> Block Number: </b>{blockNumber} <button style={{marginLeft: 24}} onClick={() => nextBlock()}>Next Block</button>
            </div>
        </div>
      </>
    );
